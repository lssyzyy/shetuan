...
public class SearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (search.equals("member")) {//查询member的所有信息 返回集合
		...
		}else if (search.equals("wcom")) {//查询community的所有信息 返回集合
			String comname = request.getParameter("name");
			String cpagestr = request.getParameter("cpage");
			int cpage = 1;
			if (cpagestr != null) {
			...
			CommunityDao communitydao = new CommunityDao();
			List<Community> communities = communitydao.getWaitCommunitiesForSearch(comname, page);
		...
		}else if (search.equals("act")) {//查询community的所有信息 返回集合
