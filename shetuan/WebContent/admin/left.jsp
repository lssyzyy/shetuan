...
<div id="left-top">
    ...
    <div style="float: left" id="my_menu" class="sdmenu">
      ...
      <div>
        <span>审核管理</span>
        <a href="Query?lru=slist" target="mainFrame" onFocus="this.blur()">创建社团审批</a>
        <a href="Query?lru=jlist" target="mainFrame" onFocus="this.blur()">创办活动审批</a>
      </div>
      <div>
        <span>社团活动</span>
        <a href="activity_add.jsp" target="mainFrame" onFocus="this.blur()">添加社团活动</a>
        <a href="activity_update.jsp" target="mainFrame" onFocus="this.blur()">更新活动公告</a>
      </div>
    </div>
</body>
</html>