  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">${member.sex}</td>
        ...
        <td align="center" valign="middle" class="borderright borderbottom">${member.phonenumber}</td>
		<td align="center" valign="middle" class="borderright borderbottom">${member.email}</td>
		<td align="center" valign="middle" class="borderright borderbottom">${member.joinclub}</td>
        <td align="center" valign="middle" class="borderbottom"><a href="${pageContext.request.contextPath}/MemberInfo?mname=${member.loginName }" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span><a href="Update?ope=udele&loginname=${member.loginName }"  target="mainFrame" onFocus="this.blur()" class="add" onclick="return confirm('确定删除吗？')">删除</a></td>
      </tr>
      </c:forEach>
