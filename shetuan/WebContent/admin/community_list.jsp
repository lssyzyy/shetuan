  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr class="bggray" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">${com.clubFinance}</td>
        <td align="center" valign="middle" class="borderright borderbottom">${com.creatername}</td>
        <td align="center" valign="middle" class="borderright borderbottom">${com.createtime}</td>
        <td align="center" valign="middle" class="borderright borderbottom">${com.clubNum}</td>
		<td align="center" valign="middle" class="borderright borderbottom">${com.clubPlace}</td>
        <td align="center" valign="middle" class="borderright borderbottom">${com.clubClassname }</td>
        <td align="center" valign="middle" class="borderbottom"><a href="${pageContext.request.contextPath}/CommunityInfo?cname=${com.clubName}" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span><a href="Update?ope=cdele&clubname=${com.clubName}" target="mainFrame" onFocus="this.blur()" class="add" onclick="return confirm('确定删除吗？')">删除</a></td>
      </tr>
      </c:forEach>
